...
class CsvStorage(Storage):
    ...
    def load(self):
        ...
        exchange_rate_data = self._load_csv(self.exchange_rate_data_file, exchange_rate_columns, "汇率")
        
        return gold_data, indices_data, exchange_rate_data

    def _load_csv(self, file_path, columns, data_name):
        if file_path.exists():
            try:
    ...
    def save(self, gold_data, indices_data, exchange_rate_data):
        """将数据保存到CSV文件"""
        try:
